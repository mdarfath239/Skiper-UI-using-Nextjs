...
const Feature = () => {
  return (
    <section className="relative w-full py-18 px-4 md:px-8 lg:px-20   text-white">
    {/* Dotted border box */}
    
    <div className="flex  items-center gap-4 border border-white/10 bg-white/4 px-5 py-3 rounded-xl mb-6 text-sm max-w-md text-white/80 ml-100">
        <div className="flex flex-col  items-center font-bold text-white">
          <ThumbsUp className="text-teal-400 w-4 h-4 mb-1" />
          <span>87%</span>
          <ThumbsDown className="text-orange-400 w-4 h-4 mt-1" />
        </div>
        <p className="leading-snug">
        of Next Js Saas Products Looks similar right ? <br /> Lets Change the approach
        </p>
      </div>

    {/* Main heading */}
    <h2 className="text-center text-3xl md:text-4xl  leading-snug mb-4">
      Components are fully designed products
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[#FF4D4F] text-xl font-bold ml-1">P</span><br />
      and even have <span className="font-extrabold">real daily active uses.</span>
    </h2>
    ...
    {/* Feature Cards */}
    <div className="max-w-7xl mx-auto bg-[#0A0A0A] rounded-[40px] px-6 py-10">
      <div className="mb-6">
        <span className="inline-flex items-center gap-2 rounded-full bg-[#1C1C1C] px-4 py-1 text-sm font-medium text-white">
          <span className="text-xl">📄</span> Additional goods
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="rounded-2xl bg-[#1C1C1C] p-5">
          <h3 className="text-white font-semibold">Free AI Marketing</h3>
        ...
        {/* Card 3 */}
        <div className="rounded-2xl bg-[#1C1C1C] p-5">
          <h3 className="text-white font-semibold">Full Stack Shadcn Templates</h3>
          <p className="text-gray-400 text-sm mt-2">
