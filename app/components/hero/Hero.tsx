...
export default function Hero() {
  return (
    <>
    <section className=" text-white mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-14">
      {/* Product Hunt badge */}
      <a
        href="https://www.producthunt.com/posts/skiper-ui?embed=true&amp;utm_source=badge-featured&amp;utm_medium=badge"
        target="_blank"
      ...
      <div className="pt-4 md:pt-0 text-center">
        <h2 className="mt-4 text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-black/80 dark:bg-white">
          Components crafted for
        </h2>
        <h1 className="text-5xl sm:text-6xl lg:text-[5.4rem] font-bold tracking-tight text-transparent bg-clip-text bg-black/80 dark:bg-white">
          Modern Websites
        </h1>
      </div>
      ...
      <div className="flex items-center justify-center">
        <a href="/docs/components/theme-toggle-animations">
          <div className="group cursor-pointer border border-[#3B3A3A] bg-[#151515] gap-2 h-[64px] flex items-center p-[11px] rounded-full mt-10">
